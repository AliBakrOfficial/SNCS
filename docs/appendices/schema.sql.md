---
title: "Appendix A — Database Schema (schema.sql)"
path: docs/appendices/schema.sql.md
version: "1.3"
summary: "النص الكامل لملف schema.sql — CREATE TABLE statements للـ 12 جدول الرئيسي"
tags: [appendix, sql, schema, ddl, mysql]
---

# Appendix A — Database Schema (schema.sql)

**Related Paths:** `backend/db/schema.sql`
